...
class SignupTests(BaseTests):
    ...
    def test_good_signup(self):
        ...
        response = self.app.post('/api/v3/auth/userregister', data=data, content_type='application/json')
    ...
    def test_same_email_signup_driver(self):
        ...
        data = json.dumps({
            ...
            "carmodel" : "Subaru"})
        response = self.app.post('/api/v3/auth/driverregister', data=data, content_type='application/json')
        self.assertEqual(response.status_code, 400)
